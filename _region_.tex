\message{ !name(../GAC_cours.tex)}\documentclass[a4paper, 12pt, usenames, dvipsnames, chapterprefix=true]{scrreprt}
...
\message{ !name(Chapters/GAC_cours-chap5.tex) !offset(233) }
$f_0, f_1 : Z
    \to Y$
\message{ !name(../GAC_cours.tex) !offset(36) }
